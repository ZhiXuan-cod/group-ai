...
# -------------------------------
# Display UMP logo at the top of the app
try:
    # Try to load from local file first
    ump_logo = Image.open("ump.logo.png")
    st.image(ump_logo, width=150)
except:
    # Fallback to online image
    st.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-4BlG0Ha-QD1KagKQ1nu6yAehi89QGqYsWQ&s", 
             width=150)

st.markdown("---")  # Add a separator line
st.set_page_config(
    page_image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-4BlG0Ha-QD1KagKQ1nu6yAehi89QGqYsWQ&s",
    page_title="UMPSA - The Calorie Detective",
    page_icon="🍎",
    layout="wide",
