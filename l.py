...
def main():
    ...
    try:
        ...
        st.sidebar.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-4BlG0Ha-QD1KagKQ1nu6yAehi89QGqYsWQ&s", 
                        width=150)
    
    # Add university name
    st.sidebar.markdown("### **University Malaysia Pahang Al-Sultan Abdullah - UMPSA**### ", size=14)
    st.sidebar.markdown("---")
