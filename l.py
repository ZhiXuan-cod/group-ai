...
st.set_page_config(
    page_image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-4BlG0Ha-QD1KagKQ1nu6yAehi89QGqYsWQ&s",
    page_title="The Calorie Detective",  # Changed from "UMPSA - The Calorie Detective"
    page_icon="🍎",
    layout="wide",
...
# -------------------------------
# 4. User Administration - UPDATED with Role Selection
# -------------------------------
class UserManager:
    def __init__(self):
...
def main():
    ...
    # Add UMP logo at the top of sidebar
    try:
        # First try to load ump_logo.png from local file
        st.sidebar.image("ump_logo.png", use_column_width=True)
    except:
        # If local file not found, use a placeholder (you can replace with actual URL)
        st.sidebar.image("https://upload.wikimedia.org/wikipedia/en/thumb/6/6b/University_of_Malaysia_Pahang_logo.svg/1200px-University_of_Malaysia_Pahang_logo.svg.png", 
                        width=150)
    ...
    # Add app title (changed from "🍎 UMPSA - The Calorie Detective" to "🍎 The Calorie Detective")
...
# -------------------------------
# 10. Page Functions - UPDATED with Role Selection
# -------------------------------
def show_login_register(user_manager):
    ...
    with col1:
        ...
        with tab2:
            ...
            # Role selection for registration - IMPROVED
            role = st.selectbox(
                "Select Your Role",
                ["Student", "Staff"],
    ...
    with col2:
        # Display logo.jpg instead of the previous image
        try:
            st.image("logo.jpg", width=250)
        except:
            # If logo.jpg is not found, use a placeholder
            st.image("https://via.placeholder.com/250x150?text=Logo.jpg", width=250)
        
        st.markdown("""
        ### 🍎 The Calorie Detective  <!-- Changed from "🍎 UMPSA - The Calorie Detective" -->
...
def show_user_profile(user_manager):
    """Display user profile - UPDATED with role display"""
